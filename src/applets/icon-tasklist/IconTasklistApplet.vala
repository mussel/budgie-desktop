...
<<<<<<< HEAD:src/applets/icon-tasklist/IconTasklistApplet.vala
...
>>>>>>> cbd4d0b... Major refactoring of the applet main code:src/panel/applets/icon-tasklist/IconTasklistApplet.vala
    ...
    private Application? get_pinned_application_by_startup_id(string startup_id)
    {
      ...
      while (iter.next(null, out pin_app)) {
          ...
          if (pbtn.id != null && pbtn.id == startup_id)) {
              return pin_app;
          }
      }
